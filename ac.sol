...
contract StandardToken is ERC20Interface, Owned, Pausable {
    ...
    constructor() {
        symbol       = 'AC';//代币符号
        name         = 'Atlantic Token';//代币名称
        decimals     = 18;
        total_supply = 20000000 * 10**uint256(decimals);//发行总量200万
        ...
        // permissions
        is_mintable = true;
        minter_list[msg.sender] = true;//铸币者清单
        access_permission[msg.sender] = true;//访问权限

        // zap helper
        liquidify  = 0x91919fAb55a1B7d0a6a4A86f674Ca75dcc971766;//lq地址

        // reserve for reward all NFT holders on tax
        nft_reward = 0xDEFf46449ab00d671B74Bc920F682D9b87905E64;//nft奖励地址
